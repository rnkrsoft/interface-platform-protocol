...
@AllArgsConstructor
@Builder
public class FetchConfigureResponse implements Serializable {
    @ApidocElement(value = "网关通道信息")
    final List<GatewayChannel> channels = new ArrayList<GatewayChannel>();
    ...
    @ApidocElement(value = "环境")
    int env;

    @ApidocElement(value = "环境描述")
    String envDesc;

    @ApidocElement(value = "模拟经度,在不自动定位时使用")
    String mockLng;

    @ApidocElement(value = "模拟维度,在不自动定位时使用")
    String mockLat;

    @ApidocElement(value = "应答代码")
    String code;

    @ApidocElement(value = "应答描述")
    String desc;

    public void setCode(EnumStringCode code) {
