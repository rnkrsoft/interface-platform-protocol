...
public class InterfaceDefinition{
    ...
    public String toString() {
        return channel + ":" + txNo + ":" + version +
                " 加密算法:" + encryptAlgorithm +
                " 签字算法:" + signAlgorithm +
                " 解密算法:" + decryptAlgorithm +
                " 验签算法:" + verifyAlgorithm +
                ", firstVerifySecondDecrypt=" + firstVerifySecondDecrypt +
                ", firstSignSecondEncrypt=" + firstSignSecondEncrypt +
                " 使用TOKEN作密码:" + useTokenAsPassword;
    }
}
